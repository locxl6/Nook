...
async def get_conversation(conversation_id: str, response: Response) -> ConversationInfo | GeneralResponse:
...
async def get_all_conversations(response: Response) -> list[ConversationInfo] | GeneralResponse:
